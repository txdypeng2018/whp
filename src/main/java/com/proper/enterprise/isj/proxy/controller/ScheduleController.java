...
public class ScheduleController extends BaseController {
    ...
    public ResponseEntity<List<DoctorScheduleDocument>> getDoctorDate(@RequestParam String doctorId, String districtId, String subjectId, String date, @RequestParam String isAppointment) {
    ...
    public ResponseEntity<List<ScheDoctorDocument>> getScheduleDoctors(String districtId, String subjectId, String major, @RequestParam String startDate, String endDate, Integer pageNo, @RequestParam String isAppointment) {
        if (pageNo == null) {
            pageNo = 1;
        }
    ...
    public ResponseEntity<List<TimeRegDocument>> getTimes(@RequestParam String date, @RequestParam String doctorId, @RequestParam String isAppointment) {

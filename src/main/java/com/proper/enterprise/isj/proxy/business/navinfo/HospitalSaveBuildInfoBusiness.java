...
@Service
public class HospitalSaveBuildInfoBusiness<M extends BuildInfoEntityContext<String> & ModifiedResultBusinessContext<String>>
    ...
    public void process(M ctx) throws Exception {
        ...
        try {
            ...
            debug("HospitalNavigationController.saveBuildInfo[Exception]:", e);

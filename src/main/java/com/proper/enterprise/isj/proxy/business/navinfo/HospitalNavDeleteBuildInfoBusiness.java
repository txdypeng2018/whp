...
@Service
public class HospitalNavDeleteBuildInfoBusiness<M extends IdsContext<Boolean> & ModifiedResultBusinessContext<Boolean>>
    ...
    public void process(M ctx) throws Exception {
        ...
        if (StringUtil.isNotNull(ids)) {
            ...
            try {
                ...
                debug("HospitalNavigationController.deleteBuildInfo[Exception]:", e);

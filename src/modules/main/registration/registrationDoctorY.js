(function(app) {
  ...
  var registrationDoctorYCtrl = function($scope, $http, $state, $stateParams, $ionicPopup, $timeout) {
  ...
  var mainRouter = function($stateProvider) {
    $stateProvider.state('mainRegistrationDoctorY', {
      url: '/main/registration/registrationDoctorY/:id',
      templateUrl: 'modules/main/registration/registrationDoctorY.html',
      controller: registrationDoctorYCtrl
    });
  };

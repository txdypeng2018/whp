(function() {
  ...
  var testRouter = function($stateProvider) {
    $stateProvider.state('main.playgroundTest', {
      url: '^/playground/test',
      templateUrl: 'modules/playground/test/test.html'
    });
  };

  angular.module('pea').config(testRouter);
  angular.module('pea').controller('DemoCtrl', function($scope) {
